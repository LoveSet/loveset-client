  ...
  return (
    <Html>
      <Tailwind>
        ...
        <Preview>
          Congratulations! You've earned 10 extra swipes for inviting a friend
          to LoveSet
        </Preview>
        <Body className="bg-[#f5f5f5] font-sans py-[40px]">
          <Container className="bg-white rounded-[8px] mx-auto my-0 p-[20px]">
            <Section>
              ...
              <Text className="text-[16px] text-[#333333] mb-[16px]">
                Great news! Your friend has joined LoveSet using your
                invitation. As a thank you, we've added{" "}
                <span className="font-bold text-[#5891ff]">
                  10 extra swipes
                </span>{" "}
                to your account.
              </Text>
              ...
              <Section className="bg-[#f0f7ff] p-[16px] rounded-[8px] mb-[24px] text-center">
                <Text className="text-[24px] text-[#5891ff] font-bold mb-[8px]">
                  +10 SWIPES
                </Text>
              ...
              <Text className="text-[16px] text-[#333333] mb-[24px]">
                These extra swipes mean more chances to discover your next
...
export default ReferralAwardEmail;
