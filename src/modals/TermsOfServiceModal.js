        ...
        <div className="modal-content terms-content">
          <div className="terms-section">
            ...
            <p>
              ...
              (the "MovieMatch Application"); (c) includes any text, pictures, media, data, text, information and other
              materials or content (collectively, the "Content") contained on or provided through (a) and (b); and (d)
